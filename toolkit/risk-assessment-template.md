...
Download this template and fill it out for each AI use case before requesting approval. Save completed assessments in the `assessments/` folder with the naming convention `UC-XXX-short-name-risk.md`.
